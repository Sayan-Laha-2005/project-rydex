...
function VehicleCard({ vehicle, distance,onBook }: { vehicle: IVehicle, distance: number | undefined, onBook:()=>void }) {
  ...
  return (
    <motion.div
      ...
      style={{ boxShadow: "0 2px 16px rga(0,0,0,0.06)" }}
    >
      <div className='relative h-48 bg-zinc-50 flex items-center justify-center overflow-hidden'>
        ...
        <div className='absolute bottom-3 left-3 z-20 flex items-center gap-1 bg-white border border-zinc-200 text-zinc-700 text-[10px] font-bold px-2.5 py-1.5 rounded-full'>
      ...
      <div className='flex flex-col flex-1 p-5 gap-4'>
        ...
        <div className='grid grid-cols-2 gap-2'>
          <div className='bg-zinc-50 border border-zinc-100 rounded-2xl px-3.5 py-3'>
            <div className='flex items-center gap-1.5 mb-1'>
              ...
              <p className='tetx-zinc-400 text-[9px] uppercase tracking-widest font-bold'>per KM</p>
            </div>
        ...
        <div className='flex items-end justify-between pt-3 border-t border-zinc-100'>
          <div>
            ...
            >
              <IndianRupee size={16} className='text-zinc-900 mb-0.5'
                strokeWidth={2.5}
              />
