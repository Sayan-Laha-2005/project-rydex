    ...
    return (
        <div className='flex flex-col h-full min-h-0 bg-white rounded-2xl overflow-hidden border border-zinc-100'>
            ...
            >
                ...
                {messages.length === 0 && (
                    <div className='flex flex-col items-center justify-center h-ful gap-3 py-16'>
            ...
            <div className='flex-shrink-0 px-4 pb-4 pt-2 bg-white'>
                <div className='flex items-center ga-2 bg-zinc-100 rounded-2xl pl-3 pr-1.5 py-1.5'>
                    {messages.length > 0 && (
                        <motion.button
                            whileTap={{ scale: 0.9 }}
                            onClick={() => getAISuggestions()}
                            className={`flex-shrink-0 w-8 h-8 rounded-xl flex items-center justify-center transition-all ${showAI
