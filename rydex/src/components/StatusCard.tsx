...
function StatusCard({icon,title,desc}:any) {
  return (
    ...
    className='bg-white rounded-2xl md:rounded-3xl p-5 sm:p-6 md:rounded-3xl p-5 sm:p-6 md:p-8 shadow-lg border flex flex-col sm:flex-row gap-4 sm:gap-5 items-start sm:items-center'
    >
