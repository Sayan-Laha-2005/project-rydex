                ...
                <div className='space-y-8'>
                    ...
                    >
                        <div className='flex justify-between text-sm'>
                            ...
                            <span className='font-semibold flex items-center gap-1'><IndianRupee size={13} /> {data?.baseFare || 0}</span>
                        </div>
                        <div className='flex justify-between text-sm'>
                            <span className='text-gray-500'>Price Per KM</span>
                            <span className='font-semibold flex items-center gap-1'><IndianRupee size={13} /> {data?.pricePerKM || 0}</span>
                        </div>
                        <div className='flex justify-between text-sm'>
                            <span className='text-gray-500'>Waiting Charge</span>
                            <span className='font-semibold flex items-center gap-1'><IndianRupee size={13} /> {data?.waitingCharge || 0}</span>
                        </div>
                    ...
                    >
                        ...
                        >
                            ...
                            <p className='text-sm text-gray-500 mt-2'>
                                <textarea placeholder='Enter rejection reason (required)'
