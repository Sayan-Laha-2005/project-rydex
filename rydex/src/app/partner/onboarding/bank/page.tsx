                ...
                <div className='mt-8 space-y-6'>
                    ...
                    <div>
                        ...
                        <div className='flex items-center gap-2 mt-2'>
                            ...
                            className={`flex-1 border-b pb-2 text-sm focus:outline-none ${!isAccountValid && accountNumber.length>0 ? "border-red-400 focus:border-red-500" : "border-gray-300 focus:border-black"}`} value={accountNumber} 
                    ...
                    <div>
                        ...
                        <div className='flex items-center gap-2 mt-2'>
                            ...
                            className={`flex-1 border-b pb-2 text-sm focus:outline-none ${!isIfscValid && ifsc.length>0 ? "border-red-400 focus:border-red-500" : "border-gray-300 focus:border-black"}`}  value={ifsc.toUpperCase()} 
                    ...
                    <div>
                        ...
                        <div className='flex items-center gap-2 mt-2'>
                            ...
                            <input type="text" id='ahn' placeholder='10 digit mobile number' 
