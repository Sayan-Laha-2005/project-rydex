                                ...
                                <div className='flex flex-col lg:flex-row lg:items-center lg:justify-between gap-8'>
                                    ...
                                    <div className='flex flex-col justify-between lg:items-end gap-6 w-full lg:w-auto'>
                                        ...
                                        <div className='flex gap-4 w-full lg:w-auto'>
                                            ...
                                            className='flex-1 lg:flex-none px-6 py-3 rounded-xl border border-gray-300 bg-white text-sm font-semibold hover:bg-gray-100 transition-all duration-200 active:scale-[0.98] disabled:opacity-50'>Reject</button>
                                            <button 
                                            onClick={()=>handleAccept(b._id)}
                                            className='flex-1 lg:flex-none px-8 py-3 rounded-xl bg-black text-white text-sm font-semiold shadow-md hover:bg-gray-900 hover:shadow-lg transition-all duration-200 active:scale-[0.98] disabled:opacity-50 flex items-center justify-center'>Accept Ride</button>
