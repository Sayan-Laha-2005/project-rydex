...
const STATUS_LABEL: Record<BookingStatus, StatusConfig> = {
    idle: {
...
const PAYMENT_BADGE: Record<PaymentStatus, BadgeConfig> = {
    pending: {
        label: "Pending",
                    ...
                    <div className="flex-shrink-0 cursor-pointer select-none"
                        ...
                        <div className="px-5 py-3 flex items-center justify-between">
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    <p className="text-sm font-bold text-zinc-400 leading-tight">{cfg.label}</p>
