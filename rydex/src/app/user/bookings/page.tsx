...
import { Bike, Calendar, Car, ChevronRightIcon, Dot, IndianRupee, Loader2, MapPin, Phone, Truck, User } from 'lucide-react'
        ...
        <div className='min-h-screen bg-gray-50'>
            ...
            <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6'>
                <div className='max-w-3xl mx-auto'>
                    ...
                    {loading && (
                        <div className='flex justify-center py-16'><Loader2 className='animate-spin w-8 h-8 text-black' />
                        </div>
                    )}
